...
Results_ALL = zeros(6,3); %Results reported in the article
participants_index = 1;
participants_files = {'2ST-GCN 1F.txt';'2ST-GCN 5F.txt';'Causal TCN.txt';'TN-FSM.txt';'TN-FSM+JD.txt';'TN-FSM+JD+SC.txt';};
